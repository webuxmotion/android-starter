...
Випуск — не кінець, а початок звичайного циклу «фіча → версія → оновлення».
Як це виглядає на практиці — в [уроці 11](11-dialog-and-notification.md):
діалог підтвердження, Snackbar і системні сповіщення.
